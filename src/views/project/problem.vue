<template>
    <div class="host">
        ...
        <el-table
            ...
            <el-table-column prop="solve_time" label="解决时间"></el-table-column>
            <el-table-column prop="prop" label="操作">
                <template slot-scope="scope">
                    <div>
                        <el-button  size="mini" @click="editExample(scope.row)">编辑</el-button>
...
<script>
import addOrUpdate from '@/views/project/problem-add-or-update'
